...
$sql = "select id, opponent, location, date from fixturesdeals LIMIT $i,$j;";
$result = mysqli_query($conn, $sql);

$sqlTotalRows = "select count(*) as total_rows from fixturesdeals;";
...
<button><a href="owner.php">owner</a></button>
<button><a href="Update">UPDATE HERE</a></button>
</div>
</div>
</body>
</html>
